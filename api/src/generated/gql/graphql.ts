...
export type MutationLoginResult = AuthPayload | InvalidInputError;

export type MutationRegisterResult = AuthPayload | InvalidInputError;
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename: 'AuthPayload', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, name: string, email: string } } | { __typename: 'InvalidInputError', fieldErrors: Array<{ __typename?: 'InvalidInputErrorField', path: Array<string>, message: string }> } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename: 'AuthPayload', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, name: string, email: string } } | { __typename: 'InvalidInputError', fieldErrors: Array<{ __typename?: 'InvalidInputErrorField', path: Array<string>, message: string }> } };
