...
export type MarkSeasonEpisodesAsSeenMutation = { __typename: 'Mutation', markSeasonEpisodesAsSeen: { __typename: 'NotFoundError', message: string } | { __typename: 'Season', id: string, episodes: Array<{ __typename: 'Episode', id: string, isSeen: boolean }> } | { __typename: 'UnauthorizedError', message: string } };
...
export type LatestSeenEpisodeToggleEpisodeSeenMutation = { __typename: 'Mutation', toggleEpisodeSeen: { __typename: 'Episode', id: string, isSeen: boolean, season: { __typename: 'Season', id: string, series: { __typename: 'Series', id: string, latestSeenEpisode?: { __typename: 'Episode', id: string, number: number, season: { __typename: 'Season', id: string, number: number } } | null, nextEpisode?: { __typename: 'Episode', id: string } | null } } } | { __typename: 'NotFoundError', message: string } | { __typename: 'UnauthorizedError', message: string } };
