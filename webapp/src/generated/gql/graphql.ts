...
export type SeriesDetailsPageQuery = { __typename: 'Query', series: { __typename: 'NotFoundError', message: string } | (
    { __typename: 'Series', id: string, imdbId: string, title: string, startYear: number, endYear?: number | null, plot?: string | null, status?: UserSeriesStatus | null, seasons: Array<{ __typename: 'Season', id: string, number: number, episodes: Array<{ __typename: 'Episode', id: string, imdbId: string, number: number, title: string, releasedAt?: string | null, imdbRating?: number | null }> }> }
    & { ' $fragmentRefs'?: { 'SeriesPoster_SeriesFragmentFragment': SeriesPoster_SeriesFragmentFragment } }
  ) };
...
export type SeriesUpdateStatusMutation = { __typename: 'Mutation', seriesUpdateStatus: { __typename: 'NotFoundError' } | { __typename: 'Series', id: string, status?: UserSeriesStatus | null } };
