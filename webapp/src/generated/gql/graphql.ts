...
export type EpisodeLine_EpisodeFragmentFragment = { __typename: 'Episode', id: string, number: number, title: string, isSeen: boolean, releasedAt?: string | null } & { ' $fragmentName'?: 'EpisodeLine_EpisodeFragmentFragment' };
...
export type ToggleEpisodeSeenMutation = { __typename: 'Mutation', toggleEpisodeSeen: { __typename: 'Episode', id: string, isSeen: boolean, season: { __typename: 'Season', id: string, series: (
      ...
      ) } } | { __typename: 'NotFoundError', message: string } | { __typename: 'UnauthorizedError', message: string } };
...
export type MarkSeasonEpisodesAsSeenMutation = { __typename: 'Mutation', markSeasonEpisodesAsSeen: { __typename: 'NotFoundError', message: string } | { __typename: 'Season', id: string, episodes: Array<{ __typename: 'Episode', id: string, isSeen: boolean }>, series: (
      { __typename: 'Series', id: string }
      & { ' $fragmentRefs'?: { 'LatestSeenEpisodeCell_SeriesFragmentFragment': LatestSeenEpisodeCell_SeriesFragmentFragment } }
    ) } | { __typename: 'UnauthorizedError', message: string } };

export type LatestSeenEpisodeCell_SeriesFragmentFragment = { __typename: 'Series', latestSeenEpisode?: { __typename: 'Episode', id: string, number: number, season: { __typename: 'Season', id: string, number: number } } | null, nextEpisode?: { __typename: 'Episode', id: string } | null } & { ' $fragmentName'?: 'LatestSeenEpisodeCell_SeriesFragmentFragment' };
...
export type LatestSeenEpisodeToggleEpisodeSeenMutation = { __typename: 'Mutation', toggleEpisodeSeen: { __typename: 'Episode', id: string, isSeen: boolean, season: { __typename: 'Season', id: string, series: (
        { __typename: 'Series', id: string }
        & { ' $fragmentRefs'?: { 'LatestSeenEpisodeCell_SeriesFragmentFragment': LatestSeenEpisodeCell_SeriesFragmentFragment } }
      ) } } | { __typename: 'NotFoundError', message: string } | { __typename: 'UnauthorizedError', message: string } };
...
export type SeriesRow_SeriesFragmentFragment = (
  ...
  & { ' $fragmentRefs'?: { 'SeriesPoster_SeriesFragmentFragment': SeriesPoster_SeriesFragmentFragment;'LatestSeenEpisodeCell_SeriesFragmentFragment': LatestSeenEpisodeCell_SeriesFragmentFragment } }
...
export type SeriesListQuery = { __typename: 'Query', userSeriesList: { __typename: 'QueryUserSeriesListSuccess', data: Array<(
      { __typename: 'Series', id: string, nextEpisode?: { __typename: 'Episode', id: string } | null }
      & { ' $fragmentRefs'?: { 'SeriesRow_SeriesFragmentFragment': SeriesRow_SeriesFragmentFragment } }
    )> } | { __typename: 'UnauthorizedError', message: string } };
